...
def add_dataset_args(parser, train=False, gen=False):
    ...
    group.add_argument('--job-id', type=str, metavar='N',
                       help='remove sentences with losses less than threshold for the next batch')
    group.add_argument('--threshold-rm', type=float, metavar='N',
                       help='remove sentences with losses less than threshold for the next batch')
    group.add_argument('--threshold-add', type=float, metavar='N',
                       help='add sentences with losses greater than threshold for the next batch')
    group.add_argument('--add', default=0, type=int, metavar='N',
                       help='should model add sentences? 1 should not model add sentences? 0')
    group.add_argument('--ignore', default=0, type=int, metavar='N',
                       help='should model ignore sentences? 1 should not model ignore sentences? 0')
    group.add_argument('--end-fixed-epoch', default=3, type=int, metavar='N',
                       help='number of first epochs without adding or ignoring sentences')
    group.add_argument('--start-fixed-epoch', default=15, type=int, metavar='N',
                       help='stop adding or ignoring sentences after this epoch')
    group.add_argument('--max-q',default=4, type=int, metavar='N',
                       help='Length of tokens queue in a batch ')
    group.add_argument('--sensivity-rm', default=10, type=int, metavar='N',
                       help='start removing sentences, soon or late?')
    group.add_argument('--save-sent-loss', type=str, metavar='DIR', default='losses_epochs_',
                       help='path and name to save loss of sentences in different epochs ')
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--save-indices', type=str, metavar='DIR', default='epoch_indices_',
                       help='name to save indices of sentences in each epochs ')
